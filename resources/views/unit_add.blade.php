...
@section('content')
    ...
    <h1 class="mt-3" style="text-align:center">Add New Unit</h1>
    ...
    <div class="mt-5">
        ...
        <form action="unit_add" method="post">
            ...
            <div class="mb-3">
                <label for="unit_address" class="form-label">Unit Address</label>
                <input type="text" name="unit_address" id="unit_address" class="form-control" placeholder="Unit Address">
            </div>
