            ...
            <tbody>
                @foreach ($deletedcategories as $item)
                    <tr>
                        ...
                        <td>{{ $item->name }}</td>
                        <td>
                            <a href="/category_restore/{{ $item->slug }}" class="btn btn-warning" name="action" data-toggle="tooltip" title="Restore" value="restore"><i class="bi bi-arrow-left-circle"></i> | Restore</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
